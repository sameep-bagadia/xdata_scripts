...
def main():
	with open('/lfs/local/0/sameepb/xdata/nyc/bucket_agg/bucket_agg2_dropoff.csv') as nycf:
		for line in nycf:
			line = line[:-1]
			line_arr = line.split(',')
	...
	outfile = '/lfs/local/0/sameepb/xdata/nyc/bucket_agg/bucket_combined2_dropoff.csv'
	counts = []
