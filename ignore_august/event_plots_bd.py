...
def main():
	...
	weekdays_count = [48,48,48,48,48,48,48]
	num_days = 337
		...
		for filename in f:
			...
			with open(filepath) as nycf:
				for line in nycf:
					...
					if (haversine(drop_lon, drop_lat, event_lon, event_lat) < 0.25):
