# Train the random forest classifier on 'data_file' using labels from 'y0' (concerts data). Use the trained classifier to predict events and store the predicted events in file 'outf_out'
...
def main():
	X_orig = np.genfromtxt('/lfs/madmax/0/sameepb/xdata/ml_data_new/data3.csv', delimiter=',')
	...
	outf_inp = open('/lfs/madmax/0/sameepb/xdata/ml_output_new/concerts_train3.tsv', 'w')
	outf_out = open('/lfs/madmax/0/sameepb/xdata/ml_output_new/concerts_pred3.tsv', 'w')
