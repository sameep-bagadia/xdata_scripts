...
def main():
	read_buckets('/lfs/madmax/0/sameepb/xdata/ml_output5/concerts_pred.tsv')
	read_buckets('/lfs/madmax/0/sameepb/xdata/ml_output5/se_pred.tsv')
	outf = open('/lfs/madmax/0/sameepb/xdata/ml_output5/merged_events.tsv', 'w')
	construct_edges()
